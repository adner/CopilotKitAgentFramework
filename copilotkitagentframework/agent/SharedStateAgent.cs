...
internal sealed class SharedStateAgent : DelegatingAIAgent
{
        ...
        [EnumeratorCancellation] CancellationToken cancellationToken = default)
    {
        ...
        var secondRunMessages = messages.Concat(response.Messages).Append(
            new ChatMessage(
                ChatRole.System,
                [new TextContent("Please provide an answer to the user if the user has asked a question. If the tools get_weather or get_contacts have been called, that means that a GUI has been showed to the user with the requested information - then you should just reply something short,  and don't repeat the information.")]));
